...
CODE CHANGE BEGIN: ------------------------------------------------------------------------------------------------------------------------------
"""
# Determine the device to use: MPS (Apple Silicon), CUDA (NVIDIA GPU), or CPU
...
def get_args(pred_config):
    # Load the training arguments saved during model training
...
def convert_input_file_to_tensor_dataset(
    ...
    # Prepare input data for prediction: convert text file to TensorDataset
...
if __name__ == "__main__":
    ...
    predict(pred_config)    # Run prediction
